...
/**
 * FamilyLogin - OOP Class-based Component
 * Handles residential family login with Firebase authentication
 */
class FamilyLogin extends React.Component {
  handleBack = () => {
        ...
        <div className='flex flex-col justify-center items-center w-full md:w-1/2 bg-white px-8 py-12'>
          <div className='w-full max-w-sm mx-auto'>
            ...
            <p className='text-gray-500 mb-8 text-center'>
              Login to your family account to manage your profile and devices.
            </p>
            {error && (
            ...
            <form className='space-y-4' onSubmit={this.handleLogin}>
              ...
              <div className='relative'>
                ...
                >
                  <FontAwesomeIcon
                    icon={showPassword ? faUsers : faEyeSlash}
                    className='text-xs'
                  />
                </span>
              </div>
